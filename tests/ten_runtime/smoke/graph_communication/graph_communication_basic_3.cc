 ...
 public:
  ...
  void on_start(ten::ten_env_t &ten_env) override {
    ...
    start_graph_cmd->set_graph_from_json(R"({
      "nodes": [{
        ...
        "addon": "graph_communication_basic_3__test_extension_2",
        "app": "msgpack://127.0.0.1:8001/",
        "extension_group": "graph_communication_basic_3__test_extension_2_group"
      },
      {
        "type": "extension",
        "name": "test_extension_3",
        "addon": "graph_communication_basic_3__test_extension_3",
        "app": "msgpack://127.0.0.1:8001/",
        "extension_group": "graph_communication_basic_3__test_extension_3_group"
      }],
      "exposed_messages": [
        {
          "type": "cmd_in",
  ...
  void on_cmd(ten::ten_env_t &ten_env,
    ...
    if (cmd->get_name() == "test") {
      ...
      auto extension = cmd->get_source().extension_name;
      ...
      if (recv_good_bye_cnt == 2) {
        // Receive the good bye from both test_extension_2 and test_extension_3.
               ...
               "predefined_graphs": [{
                 ...
                 "graph": {
                   "nodes": [{
                     ...
                     "addon": "graph_communication_basic_3__test_extension_1",
                     "extension_group": "graph_communication_basic_3__predefined_graph_group"
                   }]
                 }
               }]
             }
...
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    graph_communication_basic_3__test_extension_1, test_extension_1);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    graph_communication_basic_3__test_extension_2, test_extension_2);
TEN_CPP_REGISTER_ADDON_AS_EXTENSION(
    graph_communication_basic_3__test_extension_3, test_extension_3);

}  // namespace

TEST(GraphCommunicationTest, GraphCommunicationBasic3) {  // NOLINT
